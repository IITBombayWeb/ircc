 ...
 *   The path to rewrite.
 * @param array $options 
 *   An array of url options in outbound alter.
 * @param string $original_path
 *   The original path before altering.
 * @param string $path_language
 *   The path language in inbound alter.
 *
 * @return string
 */
 ...
 * that will be encoded into the URL. You can alter both the values and the
 * key.
 *
 ...
 *
 * @param string $path 
 *  The path that is being rewritten depending on the hook:
 ...
 * @param array $context
 *    An associative array with additional options depending
 *    on the called hook:
